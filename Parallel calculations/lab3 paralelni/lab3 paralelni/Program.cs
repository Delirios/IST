...
namespace lab3_paralelni
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[,,] arr1 = new int[5, 10,10]; //перший підмасив
            int[,,] arr2 = new int[5, 10,10]; //другий підмасив
